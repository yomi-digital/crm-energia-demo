...
const login = async () => {
  ...
  try {
    ...
    // userData viene salvato in localStorage (tramite useCookie) per evitare il limite di 4KB dei cookie
    // useCookie gestisce automaticamente il fallback a localStorage per 'userData'
