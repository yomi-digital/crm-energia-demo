    ...
    if (props.formData.selectedProduct && selectedProductData.value) {
        ...
        if (prodotto) {
            dettagliProdotto.push({
                ...
                kWp_salvato: prodotto.potenza_kwp_pannelli ? prodotto.potenza_kwp_pannelli : 0,
                ...
                capacita_batteria_salvata: prodotto.capacita_kwh || null,
                potenza_inverter_salvata: prodotto.potenza_inverter !== undefined ? prodotto.potenza_inverter : 0,
                marca_inverter_salvata: prodotto.marca_inverter || null,
                quantita_inverter_salvati: prodotto.quantita_inverter || null,
                quantita_batterie_salvate: prodotto.quantita_batterie || null,
                potenza_batterie_salvato: prodotto.potenza_batteria || null,
                marca_batteria_salvato: prodotto.marca_batteria || null,
                marca_pannelli_salvato: prodotto.marca_pannelli || null,
                quantita_pannelli_salvato: prodotto.quantita_pannelli || null,
