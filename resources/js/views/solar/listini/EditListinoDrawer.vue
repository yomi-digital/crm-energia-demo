...
watch(() => props.listino, (newListino) => {
  if (newListino) {
    nome.value = newListino.nome
    descrizione.value = newListino.descrizione
    tipoCliente.value = newListino.tipo_cliente
    tipoFase.value = newListino.tipo_fase
  }
}, { immediate: true })
</script>
