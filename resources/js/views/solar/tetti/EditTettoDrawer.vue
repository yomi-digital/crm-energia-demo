...
nomeTipologia.value = props.tetto.nome_tipologia
note.value = props.tetto.note || ''
costoExtraKwp.value = props.tetto.costo_extra_kwp || ''
...
const onSubmit = () => {
  refForm.value?.validate().then(({ valid }) => {
    if (valid) {
      const body = {
        id: props.tetto.id_voce || props.tetto.id,
