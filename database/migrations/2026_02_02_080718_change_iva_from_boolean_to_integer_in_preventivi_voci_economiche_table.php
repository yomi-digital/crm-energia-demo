...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('UPDATE preventivi_voci_economiche SET iva = CASE WHEN iva = 1 THEN 22 ELSE 0 END');
    ...
    public function down(): void
    {
        ...
        DB::statement('UPDATE preventivi_voci_economiche SET iva = CASE WHEN iva = 22 THEN 1 ELSE 0 END');
