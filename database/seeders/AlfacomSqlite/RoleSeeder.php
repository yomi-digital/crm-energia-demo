...
class RoleSeeder extends Seeder
{
    ...
    {
        $gestione = Role::where('name', 'gestione')->first();
        $backoffice = Role::where('name', 'backoffice')->first();
        $agente = Role::where('name', 'agente')->first();
        $struttura = Role::where('name', 'struttura')->first();
        $telemarketing = Role::where('name', 'telemarketing')->first();
        $teamLeader = Role::where('name', 'team leader')->first();
        $amministrazione = Role::where('name', 'amministrazione')->first();
