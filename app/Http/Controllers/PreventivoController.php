...
class PreventivoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'DETTAGLI_PRODOTTO_PREVENTIVO.*.marca_inverter_salvata' => 'required|string|max:255',
            'DETTAGLI_PRODOTTO_PREVENTIVO.*.quantita_inverter_salvati' => 'nullable|integer|min:0',
            'DETTAGLI_PRODOTTO_PREVENTIVO.*.quantita_batterie_salvate' => 'nullable|integer|min:0',
            'DETTAGLI_PRODOTTO_PREVENTIVO.*.potenza_batterie_salvato' => 'nullable|numeric|min:0',
            'DETTAGLI_PRODOTTO_PREVENTIVO.*.marca_batteria_salvato' => 'nullable|string|max:255',
            'DETTAGLI_PRODOTTO_PREVENTIVO.*.marca_pannelli_salvato' => 'nullable|string|max:255',
            'DETTAGLI_PRODOTTO_PREVENTIVO.*.quantita_pannelli_salvato' => 'nullable|integer|min:0',
